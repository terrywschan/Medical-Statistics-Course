...
Typically, clinical trials are designed to have type-I censoring, such that censoring probability and time to event are independent.
Trial designs usually involve the following steps:

- Power calculation is performed to estimate the number of events required
- The expected number of patients per year is estimated, given a desired minimum follow-up time
- The probability of event occurrence per patient is also estimated
- Finally, the running time of the study is estimated based on the above
